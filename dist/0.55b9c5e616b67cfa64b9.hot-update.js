...
let ProductController = exports.ProductController = class ProductController {
    ...
    updateProduct(productDto) {
        try {
            return new globalClass_1.ReponseData(this.productsService.updateProduct(productDto), globalEnum_1.HttpStatus.SUCCESS, globalEnum_1.HttpMessage.SUCCESS);
        }
        catch (error) {
            return new globalClass_1.ReponseData(null, globalEnum_1.HttpStatus.ERROR, globalEnum_1.HttpMessage.ERROR);
        }
...
__decorate([
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [typeof (_f = typeof product_dto_1.ProductDto !== "undefined" && product_dto_1.ProductDto) === "function" ? _f : Object]),
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("35f28e8cf707d823c208")
/******/ })();
/******/ 
/******/ }
;